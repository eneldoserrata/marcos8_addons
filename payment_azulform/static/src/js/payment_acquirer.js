$(document).ready(function () {
    ...
    $('input#cc_number').on('focusout', function (e) {
        ...
        if (card_type) {
            $(this).parent('.form-group').children('.input-group-addon').children('.card_placeholder').removeClass().addClass('card_placeholder ' + card_type);
        }
        else {
            $(this).parent('.form-group').children('.input-group-addon').children('.card_placeholder').removeClass().addClass('card_placeholder');
        }
        if (valid_value) {
